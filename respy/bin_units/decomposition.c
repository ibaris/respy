...
#define __PYX_HAVE__respy__bin_units__decomposition
#define __PYX_HAVE_API__respy__bin_units__decomposition
/* Early includes */
#include <string.h>
#include <stdio.h>
...
static const char *__pyx_f[] = {
  "respy/bin_units/decomposition.pyx",
  "__init__.pxd",
  "type.pxd",
};
...
/* Module declarations from 'respy.bin_units.decomposition' */
static PyObject *__pyx_f_5respy_9bin_units_13decomposition_bin_decompose_expr(PyObject *); /*proto*/
static PyObject *__pyx_f_5respy_9bin_units_13decomposition_bin_decompose_expr_array(PyObject *); /*proto*/
#define __Pyx_MODULE_NAME "respy.bin_units.decomposition"
extern int __pyx_module_is_main_respy__bin_units__decomposition;
int __pyx_module_is_main_respy__bin_units__decomposition = 0;

/* Implementation of 'respy.bin_units.decomposition' */
...
static const char __pyx_k_Created_on_15_03_2019_by_Ismail[] = "\nCreated on 15.03.2019 by Ismail Baris\n";
...
/* "respy/bin_units/decomposition.pyx":10
 * import sympy
 * 
...
static PyObject *__pyx_f_5respy_9bin_units_13decomposition_bin_decompose_expr(PyObject *__pyx_v_expr) {
  ...
  __Pyx_RefNannySetupContext("bin_decompose_expr", 0);

  /* "respy/bin_units/decomposition.pyx":28
 *         tuple unit
 * 
 ...
 *         unit_obj = expr
 */
  __pyx_t_1 = __Pyx_PyObject_CallOneArg(((PyObject *)(&PyString_Type)), ((PyObject *)Py_TYPE(__pyx_v_expr))); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 28, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = (__Pyx_PySequence_ContainsTF(__pyx_n_s_Pow, __pyx_t_1, Py_EQ)); if (unlikely(__pyx_t_2 < 0)) __PYX_ERR(0, 28, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_3 = (__pyx_t_2 != 0);
  if (__pyx_t_3) {

    /* "respy/bin_units/decomposition.pyx":29
 * 
 *     if 'Pow' in str(type(expr)):
 *         value = 1             # <<<<<<<<<<<<<<
 *         unit_obj = expr
 ...
 */
    ...
    /* "respy/bin_units/decomposition.pyx":30
 *     if 'Pow' in str(type(expr)):
 *         value = 1
 *         unit_obj = expr             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "respy/bin_units/decomposition.pyx":32
 *         unit_obj = expr
 * 
 *     elif 'Mul' in str(type(expr)):             # <<<<<<<<<<<<<<
 *         value = expr.args[0]
 * 
 */
  __pyx_t_1 = __Pyx_PyObject_CallOneArg(((PyObject *)(&PyString_Type)), ((PyObject *)Py_TYPE(__pyx_v_expr))); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 32, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = (__Pyx_PySequence_ContainsTF(__pyx_n_s_Mul, __pyx_t_1, Py_EQ)); if (unlikely(__pyx_t_3 < 0)) __PYX_ERR(0, 32, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_2 = (__pyx_t_3 != 0);
  if (likely(__pyx_t_2)) {

    /* "respy/bin_units/decomposition.pyx":33
 * 
 *     elif 'Mul' in str(type(expr)):
 *         value = expr.args[0]             # <<<<<<<<<<<<<<
 * 
 *         try:
 */
    __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_expr, __pyx_n_s_args); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 33, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    ...
    /* "respy/bin_units/decomposition.pyx":35
 *         value = expr.args[0]
 * 
 *         try:             # <<<<<<<<<<<<<<
 *             value = float(value)
 ...
 */
    {
      ...
      /*try:*/ {
        ...
        /* "respy/bin_units/decomposition.pyx":36
 * 
 *         try:
 *             value = float(value)             # <<<<<<<<<<<<<<
 *             unit = expr.args[1:]
 * 
 */
        __pyx_t_4 = __Pyx_PyNumber_Float(__pyx_v_value); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 36, __pyx_L4_error)
        __Pyx_GOTREF(__pyx_t_4);
        __Pyx_DECREF_SET(__pyx_v_value, __pyx_t_4);
        __pyx_t_4 = 0;

        /* "respy/bin_units/decomposition.pyx":37
 *         try:
 *             value = float(value)
 *             unit = expr.args[1:]             # <<<<<<<<<<<<<<
 * 
 *             if len(unit) == 1:
 */
        __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_v_expr, __pyx_n_s_args); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 37, __pyx_L4_error)
        __Pyx_GOTREF(__pyx_t_4);
        __pyx_t_1 = __Pyx_PyObject_GetSlice(__pyx_t_4, 1, 0, NULL, NULL, &__pyx_slice_, 1, 0, 1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 37, __pyx_L4_error)
        __Pyx_GOTREF(__pyx_t_1);
        __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
        if (!(likely(PyTuple_CheckExact(__pyx_t_1))||((__pyx_t_1) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected %.16s, got %.200s", "tuple", Py_TYPE(__pyx_t_1)->tp_name), 0))) __PYX_ERR(0, 37, __pyx_L4_error)
        __pyx_v_unit = ((PyObject*)__pyx_t_1);
        __pyx_t_1 = 0;

        /* "respy/bin_units/decomposition.pyx":39
 *             unit = expr.args[1:]
 * 
 *             if len(unit) == 1:             # <<<<<<<<<<<<<<
 *                 unit_obj = unit[0]
 ...
 */
        ...
        __pyx_t_8 = PyTuple_GET_SIZE(__pyx_v_unit); if (unlikely(__pyx_t_8 == ((Py_ssize_t)-1))) __PYX_ERR(0, 39, __pyx_L4_error)
        __pyx_t_2 = ((__pyx_t_8 == 1) != 0);
        if (__pyx_t_2) {

          /* "respy/bin_units/decomposition.pyx":40
 * 
 *             if len(unit) == 1:
 *                 unit_obj = unit[0]             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
          ...
          __pyx_t_1 = __Pyx_GetItemInt_Tuple(__pyx_v_unit, 0, long, 1, __Pyx_PyInt_From_long, 0, 0, 1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 40, __pyx_L4_error)
          __Pyx_GOTREF(__pyx_t_1);
 ...
 */
        ...
        /* "respy/bin_units/decomposition.pyx":42
 *                 unit_obj = unit[0]
 *             else:
 *                 unit_obj = unit[0]             # <<<<<<<<<<<<<<
 * 
 ...
 */
        /*else*/ {
          ...
          __pyx_t_1 = __Pyx_GetItemInt_Tuple(__pyx_v_unit, 0, long, 1, __Pyx_PyInt_From_long, 0, 0, 1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 42, __pyx_L4_error)
          __Pyx_GOTREF(__pyx_t_1);
          __pyx_v_unit_obj = __pyx_t_1;
          __pyx_t_1 = 0;

          /* "respy/bin_units/decomposition.pyx":44
 *                 unit_obj = unit[0]
 * 
 *                 for i in range(1, len(unit)):             # <<<<<<<<<<<<<<
 *                     unit_obj *= unit[i]
 ...
 */
          ...
          __pyx_t_8 = PyTuple_GET_SIZE(__pyx_v_unit); if (unlikely(__pyx_t_8 == ((Py_ssize_t)-1))) __PYX_ERR(0, 44, __pyx_L4_error)
          __pyx_t_9 = __pyx_t_8;
          for (__pyx_t_10 = 1; __pyx_t_10 < __pyx_t_9; __pyx_t_10+=1) {
            __pyx_v_i = __pyx_t_10;

            /* "respy/bin_units/decomposition.pyx":45
 * 
 *                 for i in range(1, len(unit)):
 *                     unit_obj *= unit[i]             # <<<<<<<<<<<<<<
 * 
 ...
 */
            ...
            __pyx_t_1 = __Pyx_GetItemInt_Tuple(__pyx_v_unit, __pyx_v_i, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 1, 1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 45, __pyx_L4_error)
            __Pyx_GOTREF(__pyx_t_1);
            __pyx_t_4 = PyNumber_InPlaceMultiply(__pyx_v_unit_obj, __pyx_t_1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 45, __pyx_L4_error)
            __Pyx_GOTREF(__pyx_t_4);
            __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
      ...
      /* "respy/bin_units/decomposition.pyx":47
 *                     unit_obj *= unit[i]
 * 
 *         except TypeError:             # <<<<<<<<<<<<<<
 *             value = 1
 ...
 */
      ...
      if (__pyx_t_11) {
        __Pyx_AddTraceback("respy.bin_units.decomposition.bin_decompose_expr", __pyx_clineno, __pyx_lineno, __pyx_filename);
        if (__Pyx_GetException(&__pyx_t_4, &__pyx_t_1, &__pyx_t_12) < 0) __PYX_ERR(0, 47, __pyx_L6_except_error)
        __Pyx_GOTREF(__pyx_t_4);
        __Pyx_GOTREF(__pyx_t_1);
        __Pyx_GOTREF(__pyx_t_12);

        /* "respy/bin_units/decomposition.pyx":48
 * 
 *         except TypeError:
 *             value = 1             # <<<<<<<<<<<<<<
 *             unit_obj = expr
 ...
 */
        ...
        /* "respy/bin_units/decomposition.pyx":49
 *         except TypeError:
 *             value = 1
 *             unit_obj = expr             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "respy/bin_units/decomposition.pyx":52
 * 
 *     else:
 ...
 */
  /*else*/ {
    __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_kp_s_Data_type_0_not_understood, __pyx_n_s_format); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 52, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_4 = __Pyx_PyObject_CallOneArg(((PyObject *)(&PyString_Type)), __pyx_v_expr); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 52, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_13 = NULL;
    ...
    __Pyx_GOTREF(__pyx_t_12);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_1 = __Pyx_PyObject_CallOneArg(__pyx_builtin_TypeError, __pyx_t_12); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 52, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
  ...
  /* "respy/bin_units/decomposition.pyx":54
 *         raise TypeError("Data type {0} not understood.".format(str(expr)))
 * 
 *     return value, unit_obj             # <<<<<<<<<<<<<<
 * 
...
/* "respy/bin_units/decomposition.pyx":56
 *     return value, unit_obj
 * 
 * cdef tuple bin_decompose_expr_array(value):             # <<<<<<<<<<<<<<
 *     """
...
static PyObject *__pyx_f_5respy_9bin_units_13decomposition_bin_decompose_expr_array(PyObject *__pyx_v_value) {
  PyObject *__pyx_v_shape = 0;
  Py_ssize_t __pyx_v_i;
  PyObject *__pyx_v_value_flatten = NULL;
  PyObject *__pyx_v_pure_value = NULL;
  ...
  int __pyx_t_9;
  int __pyx_t_10;
  __Pyx_RefNannySetupContext("bin_decompose_expr_array", 0);

  /* "respy/bin_units/decomposition.pyx":74
 *         Py_ssize_t i
 * 
 *     shape = value.shape             # <<<<<<<<<<<<<<
 ...
 * 
 */
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_value, __pyx_n_s_shape); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 74, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (!(likely(PyTuple_CheckExact(__pyx_t_1))||((__pyx_t_1) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected %.16s, got %.200s", "tuple", Py_TYPE(__pyx_t_1)->tp_name), 0))) __PYX_ERR(0, 74, __pyx_L1_error)
  __pyx_v_shape = ((PyObject*)__pyx_t_1);
  __pyx_t_1 = 0;

  /* "respy/bin_units/decomposition.pyx":75
 * 
 *     shape = value.shape
 *     value_flatten = value.flatten()             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_v_value, __pyx_n_s_flatten); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 75, __pyx_L1_error)
  ...
  /* "respy/bin_units/decomposition.pyx":77
 *     value_flatten = value.flatten()
 * 
 *     pure_value = np.zeros_like(value_flatten)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_zeros_like); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 77, __pyx_L1_error)
  ...
  __pyx_v_pure_value = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "respy/bin_units/decomposition.pyx":78
 * 
 *     pure_value = np.zeros_like(value_flatten)
 *     unit = np.zeros_like(value_flatten, dtype=np.object)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_zeros_like); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 78, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_object); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 78, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  if (PyDict_SetItem(__pyx_t_2, __pyx_n_s_dtype, __pyx_t_5) < 0) __PYX_ERR(0, 78, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_t_1, __pyx_t_2); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 78, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  ...
  /* "respy/bin_units/decomposition.pyx":80
 *     unit = np.zeros_like(value_flatten, dtype=np.object)
 * 
 *     for i, item in enumerate(value_flatten):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (likely(PyList_CheckExact(__pyx_v_value_flatten)) || PyTuple_CheckExact(__pyx_v_value_flatten)) {
    ...
    __pyx_t_7 = -1; __pyx_t_5 = PyObject_GetIter(__pyx_v_value_flatten); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 80, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
  ...
  for (;;) {
    if (likely(!__pyx_t_8)) {
      if (likely(PyList_CheckExact(__pyx_t_5))) {
        ...
        __pyx_t_2 = PyList_GET_ITEM(__pyx_t_5, __pyx_t_7); __Pyx_INCREF(__pyx_t_2); __pyx_t_7++; if (unlikely(0 < 0)) __PYX_ERR(0, 80, __pyx_L1_error)
        #else
        __pyx_t_2 = PySequence_ITEM(__pyx_t_5, __pyx_t_7); __pyx_t_7++; if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 80, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_2);
        #endif
      } else {
        if (__pyx_t_7 >= PyTuple_GET_SIZE(__pyx_t_5)) break;
        #if CYTHON_ASSUME_SAFE_MACROS && !CYTHON_AVOID_BORROWED_REFS
        __pyx_t_2 = PyTuple_GET_ITEM(__pyx_t_5, __pyx_t_7); __Pyx_INCREF(__pyx_t_2); __pyx_t_7++; if (unlikely(0 < 0)) __PYX_ERR(0, 80, __pyx_L1_error)
        #else
        __pyx_t_2 = PySequence_ITEM(__pyx_t_5, __pyx_t_7); __pyx_t_7++; if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 80, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_2);
        #endif
    ...
    /* "respy/bin_units/decomposition.pyx":81
 * 
 *     for i, item in enumerate(value_flatten):
 *         pure_value[i], unit[i] = bin_decompose_expr(item)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_t_2 = __pyx_f_5respy_9bin_units_13decomposition_bin_decompose_expr(__pyx_v_item); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 81, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    ...
    if (unlikely(__Pyx_SetItemInt(__pyx_v_pure_value, __pyx_v_i, __pyx_t_1, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 1, 1) < 0)) __PYX_ERR(0, 81, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    if (unlikely(__Pyx_SetItemInt(__pyx_v_unit, __pyx_v_i, __pyx_t_3, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 1, 1) < 0)) __PYX_ERR(0, 81, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
  ...
  /* "respy/bin_units/decomposition.pyx":83
 *         pure_value[i], unit[i] = bin_decompose_expr(item)
 * 
 *     pure_value = pure_value.reshape(shape)             # <<<<<<<<<<<<<<
 ...
 * 
 */
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_v_pure_value, __pyx_n_s_reshape); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 83, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = NULL;
  if (CYTHON_UNPACK_METHODS && likely(PyMethod_Check(__pyx_t_2))) {
    __pyx_t_3 = PyMethod_GET_SELF(__pyx_t_2);
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF_SET(__pyx_v_pure_value, __pyx_t_5);
  __pyx_t_5 = 0;

  /* "respy/bin_units/decomposition.pyx":84
 * 
 *     pure_value = pure_value.reshape(shape)
 *     unit = unit.reshape(shape)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_v_unit, __pyx_n_s_reshape); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 84, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = NULL;
  if (CYTHON_UNPACK_METHODS && likely(PyMethod_Check(__pyx_t_2))) {
    __pyx_t_3 = PyMethod_GET_SELF(__pyx_t_2);
  ...
  /* "respy/bin_units/decomposition.pyx":86
 *     unit = unit.reshape(shape)
 * 
 *     if False in [unit[0] == item for item in unit]:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_5);
  if (likely(PyList_CheckExact(__pyx_v_unit)) || PyTuple_CheckExact(__pyx_v_unit)) {
    __pyx_t_2 = __pyx_v_unit; __Pyx_INCREF(__pyx_t_2); __pyx_t_6 = 0;
    __pyx_t_8 = NULL;
  } else {
    __pyx_t_6 = -1; __pyx_t_2 = PyObject_GetIter(__pyx_v_unit); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 86, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
  ...
  for (;;) {
    if (likely(!__pyx_t_8)) {
      if (likely(PyList_CheckExact(__pyx_t_2))) {
        ...
        #if CYTHON_ASSUME_SAFE_MACROS && !CYTHON_AVOID_BORROWED_REFS
        __pyx_t_3 = PyList_GET_ITEM(__pyx_t_2, __pyx_t_6); __Pyx_INCREF(__pyx_t_3); __pyx_t_6++; if (unlikely(0 < 0)) __PYX_ERR(0, 86, __pyx_L1_error)
        #else
        __pyx_t_3 = PySequence_ITEM(__pyx_t_2, __pyx_t_6); __pyx_t_6++; if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 86, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_3);
        #endif
      } else {
        if (__pyx_t_6 >= PyTuple_GET_SIZE(__pyx_t_2)) break;
        #if CYTHON_ASSUME_SAFE_MACROS && !CYTHON_AVOID_BORROWED_REFS
        __pyx_t_3 = PyTuple_GET_ITEM(__pyx_t_2, __pyx_t_6); __Pyx_INCREF(__pyx_t_3); __pyx_t_6++; if (unlikely(0 < 0)) __PYX_ERR(0, 86, __pyx_L1_error)
        #else
        __pyx_t_3 = PySequence_ITEM(__pyx_t_2, __pyx_t_6); __pyx_t_6++; if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 86, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_3);
        #endif
    ...
    __pyx_t_3 = 0;
    __pyx_t_3 = __Pyx_GetItemInt(__pyx_v_unit, 0, long, 1, __Pyx_PyInt_From_long, 0, 0, 1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 86, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_1 = PyObject_RichCompare(__pyx_t_3, __pyx_v_item, Py_EQ); __Pyx_XGOTREF(__pyx_t_1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 86, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    if (unlikely(__Pyx_ListComp_Append(__pyx_t_5, (PyObject*)__pyx_t_1))) __PYX_ERR(0, 86, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  }
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_9 = (__Pyx_PySequence_ContainsTF(Py_False, __pyx_t_5, Py_EQ)); if (unlikely(__pyx_t_9 < 0)) __PYX_ERR(0, 86, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_10 = (__pyx_t_9 != 0);
  if (unlikely(__pyx_t_10)) {

    /* "respy/bin_units/decomposition.pyx":87
 * 
 *     if False in [unit[0] == item for item in unit]:
 *         raise ValueError("If the input is an array, the units for all values must be equal.")             # <<<<<<<<<<<<<<
 *     else:
 * 
 */
    __pyx_t_5 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple__2, NULL); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 87, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
 ...
 */
  ...
  /* "respy/bin_units/decomposition.pyx":90
 *     else:
 * 
 ...
 */
  /*else*/ {
    __Pyx_XDECREF(__pyx_r);
    __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_v_pure_value, __pyx_n_s_astype); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 90, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_GetModuleGlobalName(__pyx_t_1, __pyx_n_s_np); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 90, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_double); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 90, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_1 = NULL;
    if (CYTHON_UNPACK_METHODS && likely(PyMethod_Check(__pyx_t_2))) {
    ...
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_t_2 = __Pyx_GetItemInt(__pyx_v_unit, 0, long, 1, __Pyx_PyInt_From_long, 0, 0, 1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 90, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
 ...
 */
  ...
  __Pyx_AddTraceback("respy.bin_units.decomposition.bin_decompose_expr_array", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XDECREF(__pyx_v_shape);
  __Pyx_XDECREF(__pyx_v_value_flatten);
  __Pyx_XDECREF(__pyx_v_pure_value);
  __Pyx_XDECREF(__pyx_v_unit);
...
/* "respy/bin_units/decomposition.pyx":92
 *         return pure_value.astype(np.double), unit[0]
 * 
 * cdef tuple bin_decompose(value):             # <<<<<<<<<<<<<<
 *     """
...
static PyObject *__pyx_f_5respy_9bin_units_13decomposition_bin_decompose(PyObject *__pyx_v_value) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
  ...
  PyObject *__pyx_t_5 = NULL;
  PyObject *__pyx_t_6 = NULL;
  __Pyx_RefNannySetupContext("bin_decompose", 0);

  /* "respy/bin_units/decomposition.pyx":106
 *     """
 * 
 ...
 */
  __Pyx_GetModuleGlobalName(__pyx_t_1, __pyx_n_s_sympy); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 106, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_core); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 106, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_all_classes); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 106, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PySequence_Tuple(__pyx_t_1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 106, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_3 = PyObject_IsInstance(__pyx_v_value, __pyx_t_2); if (unlikely(__pyx_t_3 == ((int)-1))) __PYX_ERR(0, 106, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_4 = (__pyx_t_3 != 0);
  if (__pyx_t_4) {

    /* "respy/bin_units/decomposition.pyx":107
 * 
 *     if isinstance(value, tuple(sympy.core.all_classes)):
 *         return bin_decompose_expr(value)             # <<<<<<<<<<<<<<
 *     elif isinstance(value, np.ndarray):
 ...
 */
    __Pyx_XDECREF(__pyx_r);
    __pyx_t_2 = __pyx_f_5respy_9bin_units_13decomposition_bin_decompose_expr(__pyx_v_value); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 107, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
 ...
 */
  ...
  /* "respy/bin_units/decomposition.pyx":108
 *     if isinstance(value, tuple(sympy.core.all_classes)):
 *         return bin_decompose_expr(value)
 *     elif isinstance(value, np.ndarray):             # <<<<<<<<<<<<<<
 *         return bin_decompose_expr_array(value)
 ...
 */
  ...
  if (likely(__pyx_t_3)) {
    ...
    /* "respy/bin_units/decomposition.pyx":109
 *         return bin_decompose_expr(value)
 *     elif isinstance(value, np.ndarray):
 *         return bin_decompose_expr_array(value)             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
    __Pyx_XDECREF(__pyx_r);
    __pyx_t_2 = __pyx_f_5respy_9bin_units_13decomposition_bin_decompose_expr_array(__pyx_v_value); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 109, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_r = ((PyObject*)__pyx_t_2);
    __pyx_t_2 = 0;
    goto __pyx_L0;
 ...
 */
  ...
  /* "respy/bin_units/decomposition.pyx":111
 *         return bin_decompose_expr_array(value)
 *     else:
 *         raise TypeError("{} is not a valid expression.".format(str(value)))             # <<<<<<<<<<<<<<
 */
  /*else*/ {
    __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_kp_s_is_not_a_valid_expression, __pyx_n_s_format); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 111, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_5 = __Pyx_PyObject_CallOneArg(((PyObject *)(&PyString_Type)), __pyx_v_value); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 111, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_6 = NULL;
    if (CYTHON_UNPACK_METHODS && likely(PyMethod_Check(__pyx_t_1))) {
    ...
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_1 = __Pyx_PyObject_CallOneArg(__pyx_builtin_TypeError, __pyx_t_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 111, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __Pyx_Raise(__pyx_t_1, 0, 0, 0);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  __Pyx_AddTraceback("respy.bin_units.decomposition.bin_decompose", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
static struct PyModuleDef __pyx_moduledef = {
    ...
    "decomposition",
    __pyx_k_Created_on_15_03_2019_by_Ismail, /* m_doc */
  #if CYTHON_PEP489_MULTI_PHASE_INIT
    0, /* m_size */
  #else
    -1, /* m_size */
 ...
 * 
 */
  __pyx_tuple__2 = PyTuple_Pack(1, __pyx_kp_s_If_the_input_is_an_array_the_uni); if (unlikely(!__pyx_tuple__2)) __PYX_ERR(0, 87, __pyx_L1_error)
...
static int __Pyx_modinit_function_export_code(void) {
  ...
  if (__Pyx_ExportFunction("bin_decompose", (void (*)(void))__pyx_f_5respy_9bin_units_13decomposition_bin_decompose, "PyObject *(PyObject *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
if (!__Pyx_RefNanny) {
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("decomposition", __pyx_methods, __pyx_k_Created_on_15_03_2019_by_Ismail, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_respy__bin_units__decomposition) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "respy.bin_units.decomposition")) {
      if (unlikely(PyDict_SetItemString(modules, "respy.bin_units.decomposition", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "respy/bin_units/decomposition.pyx":6
 * Created on 15.03.2019 by Ismail Baris
 * """
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 ...
 */
  ...
  /* "respy/bin_units/decomposition.pyx":8
 * import numpy as np
 * cimport numpy as np
 * import sympy             # <<<<<<<<<<<<<<
 * 
 * cdef tuple bin_decompose_expr(object expr):
 */
  __pyx_t_1 = __Pyx_Import(__pyx_n_s_sympy, 0, -1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_sympy, __pyx_t_1) < 0) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "respy/bin_units/decomposition.pyx":1
 * # -*- coding: utf-8 -*-             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init respy.bin_units.decomposition", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init respy.bin_units.decomposition");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
